...
docker build -t pradeepp28/multi-client:latest -t pradeepp28/multi-server:$SHA -f ./server/Dockerfile ./server
docker build -t pradeepp28/multi-client:latest -t pradeepp28/multi-worker:$SHA -f ./worker/Dockerfile ./worker
